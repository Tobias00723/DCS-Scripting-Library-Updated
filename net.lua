...
do
    ...
    net = {
        ...
        PS_EXTRA_ENEMY_FIGHTERS = 8,
        PS_EXTRA_ENEMY_TRANSPORTS = 9,
        PS_EXTRA_ENEMY_SAM = 10,
        PS_EXTRA_ENEMY_AAA = 11,
        PS_EXTRA_ENEMY_TROOPS = 12,
        PS_EXTRA_ALLY_FIGHTERS = 13,
        PS_EXTRA_ALLY_TRANSPORTS = 14,
        PS_EXTRA_ALLY_SAM = 15,
        PS_EXTRA_ALLY_AAA = 16,
        PS_EXTRA_ALLY_TROOPS = 17,
